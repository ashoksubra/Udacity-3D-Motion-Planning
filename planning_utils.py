...
# Pruning using Bresenham (pythonlib provided)
...
def prune_path_bres(grid, path):
    ...
    while i < len(pruned_path) - 2:
        ...
        pts_bres_return = bresenham(p1[0], p1[1], p3[0], p3[1])
        if all(grid[point[0], point[1]] == 0 for point in pts_bres_return):
